...
- **Always handle the failure branch.** Handle `false` from `TryGetResult` for any model. The offline checks establish failure handling, not failure rates under load.
