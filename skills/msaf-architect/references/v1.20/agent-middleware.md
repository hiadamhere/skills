...
*Experimental-gate metadata recheck (2026-09-20): retained probe-agent-correctness, executed against MAF 1.20.0, confirms the experimental attribute on the background options type and the bypass property, and its absence on concurrent invocation. This supports the type/member distinction above without re-dating unrelated historical claims.*
