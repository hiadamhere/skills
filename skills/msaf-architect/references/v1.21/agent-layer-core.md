...
- Pin the agent, abstractions, and workflows packages to the same `1.21.0` version; the three ship in lockstep. MAF 1.21.0 requires `Microsoft.Extensions.AI` 10.10.0 or later.
