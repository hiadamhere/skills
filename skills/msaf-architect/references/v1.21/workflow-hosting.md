# 🧭 Hosting a Workflow as an Agent (v1.21)
...
*Checkpoint identity recheck (2026-09-20): retained `probe-agent-correctness`, executed against this page's package pin, asserts all three same-instance cases above, the positive copy case, preservation of an explicit id, and the original/copy `UsesOwnCheckpointStorage` values. This adds execution evidence without re-dating unrelated historical claims.*
