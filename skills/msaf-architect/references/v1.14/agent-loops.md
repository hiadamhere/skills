...
The loop-agent public API is byte-identical to v1.13. Use the construction, evaluator, termination, and iteration-limit patterns in [the v1.13 loop guide](../v1.13/agent-loops.md).

## 🧭 Choosing the right primitive in v1.14
...
---
*Verified against MAF v1.14.0 DLL surface (2026-07-22). The loop-agent surface is byte-identical to v1.13 by mechanical diff.*
