...
The loop-agent public API is byte-identical to v1.14. Use the construction, evaluator, termination, and iteration-limit patterns in [the v1.13 loop guide](../v1.13/agent-loops.md), and the engineering guidance in [the v1.14 loop guide](../v1.14/agent-loops.md).

## 🧭 Choosing the right primitive in v1.15
...
---
*Verified against MAF v1.15.0 DLL surface (2026-08-01). The loop-agent surface is byte-identical to v1.14 by mechanical diff.*
