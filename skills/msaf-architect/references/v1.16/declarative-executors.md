...
---
*Verified against MAF v1.16.0 DLL surface (2026-08-12). The `[Obsolete]` marker on `ReflectingExecutor` and the `protected abstract ConfigureProtocol` (CS0618, CS0534) are invisible to a reflection dump; the v1.11 guide's current shape was executed, not merely compiled.*
