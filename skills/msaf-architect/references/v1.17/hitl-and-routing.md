# 🔀 Human-in-the-Loop and Routing (v1.17)
...
---
*Verified against MAF v1.17.0 DLL surface and compile tests (2026-08-05). The routing and HITL surface is byte-identical to v1.16 by mechanical diff, and the `MAAI001` gate on the Magentic prompt surface was re-confirmed by compile test against the 1.17.0 packages.*
