...
---
*Verified against MAF v1.17.0 DLL surface (2026-08-12). The 21-type event set is identical across v1.11–v1.19 by mechanical diff (range extended to v1.19 on 2026-08-27); the probe behind the v1.11 guide compiles unmodified against pinned 1.11.0, 1.14.0 and 1.17.0.*
