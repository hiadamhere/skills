# 🧠 Agent Layer & Tools Integration (v1.13)
...
---
*Verified against MAF v1.13.0 DLL surface (2026-07-07). The agent-core layer (`AIAgent`, `ChatClientAgent`, `AIAgentBinding`) and the Workflows layer are byte-identical to v1.12 (mechanical surface diff), so the v1.12 compile-tested samples apply unchanged.*
